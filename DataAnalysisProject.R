...
#PopularityIndex code # Replace with Liv's formula
train$popularity_index <- (train$review_scores_cleanliness*2 + train$review_scores_checkin*2 +
                             train$review_scores_location*2 +train$review_scores_value*2 +
                             train$review_scores_location*2 )
...
train_temp <- train[1:50,]
library(leaflet)

#leaflet(data = train_temp) %>% addTiles() %>%
 # addMarkers(~longitude, ~latitude, popup = ~street)

mutate(train_temp, group = cut(popularity_index, breaks = c(100, 98, 96, 94, Inf), labels = c("100", "90", "80","70"))) -> mytemp
...
airbnbIcons <- iconList("100" = makeIcon("/Users/amrata/Documents/Data Analytics/DA_Proj/100.png", iconWidth = 24, iconHeight =32),
                       "90" = makeIcon("/Users/amrata/Documents/Data Analytics/DA_Proj/90.png", iconWidth = 24, iconHeight =32),
                       "80" = makeIcon("/Users/amrata/Documents/Data Analytics/DA_Proj/80.png", iconWidth = 24, iconHeight =32),
                       "70" = makeIcon("/Users/amrata/Documents/Data Analytics/DA_Proj/70.png", iconWidth = 24, iconHeight =32))

pop_string <- paste(train_temp$street,"<br>",
                    "Property Type: ",train_temp$property_type,"<br>",
                    "Accomodates: ",train_temp$accommodates,"<br>",
                    "Price: ",train_temp$price)
